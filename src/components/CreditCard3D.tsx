      ...
      >
        ...
        >
          ...
          <div className="z-10 mt-3 sm:mt-7">
            <p className="font-mono text-sm min-[360px]:text-base min-[400px]:text-lg sm:text-2xl font-bold tracking-[0.08em] min-[360px]:tracking-[0.12em] sm:tracking-[0.16em] text-white text-shadow drop-shadow-md select-all">
              {displayCardNumber}
            </p>
          </div>
          ...
          <div className="flex justify-between items-end z-10">
            ...
            <div className="text-right">
              ...
              <p className="text-[10px] min-[360px]:text-xs sm:text-sm font-mono font-bold text-white tracking-wider">
                {displayExpiry}
              </p>
            </div>
          </div>
