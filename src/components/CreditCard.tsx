      ...
      >
        ...
        >
          ...
          <div className="z-10 mt-6 sm:mt-8">
            <p className="font-mono text-lg sm:text-2xl font-medium tracking-[0.18em] text-white text-shadow drop-shadow-md select-all">
              {displayCardNumber}
            </p>
          </div>
          ...
          <div className="flex justify-between items-end z-10">
            ...
            <div className="text-right">
              ...
              <p className="text-xs sm:text-sm font-mono font-medium text-white tracking-wider">
                {displayExpiry}
              </p>
            </div>
          </div>
